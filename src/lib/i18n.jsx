...
export const TRANSLATIONS = {
  en: {
    ...
    'work.linkDetectedApp': 'Detected: {app} • Opens in desktop app',
    'work.linkDetectedWeb': 'Detected: {app} • Opens in browser',
    'ledger.openInApp': 'Open in {app}',
  ...
  fa: {
    ...
    'work.linkDetectedApp': 'شناسایی شد: {app} • باز شدن در برنامه دسکتاپ',
    'work.linkDetectedWeb': 'شناسایی شد: {app} • باز شدن در مرورگر',
    'ledger.openInApp': 'باز کردن در {app}',
